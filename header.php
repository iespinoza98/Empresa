...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-FZJKFPF3W7"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-FZJKFPF3W7');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-K6B4ZFL');</script>
    <!-- End Google Tag Manager -->
</head>
<body>
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K6B4ZFL"
