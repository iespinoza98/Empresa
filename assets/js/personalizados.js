...
function addElements (sName) {
    let aServicios = {
        ...
        "sTienda": {
            ...
            parrafo: "En la actulidad existen diversas platformas(CMS) que permiten el diseño de tiendas virtuales con mayor rapidez. Para ello adaptamos un diseño exclusivo y estructura integrando todas las funcionalidades y plugins necesarios"
        },
        "sSistemas": {
            titulo: "Sistemas Web",
    ...
    $('#contentsService').append('<div class="image mb-40"> <img src="assets/images/services/service-details.jpg" alt="Service Details"> </div>');
