        ...
        <!-- About Section Start -->
        <section class="about-three pt-120 rpt-100 pb-240 rpb-150">
            <div class="container">
        ...
        <!-- Wrok Progress Start -->
        <section class="work-progress-three bg-blue text-white pb-85 rpb-65" style="background-image: url(assets/images/background/progress.png);">
            <div class="container">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                               <label for="number">Celular</label>
                                                <input type="text" id="number" name="celular" class="form-control" placeholder="Celular" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
